...
function RadioCallingInPoint(feature, featurePortrayal, contextParameters)
    if feature.PrimitiveType == PrimitiveType.Point and contextParameters.SIMPLIFIED_POINTS then
        if feature.trafficFlow == 1 and feature.orientation[1] and feature.orientation[1].orientationValue then
            ...
            featurePortrayal:AddPointInstruction(Symbol.CreateSymbol('RDOCAL02', feature.orientation.orientationValue, Graphics.CRSType.Geographic))
        ...
        elseif feature.trafficFlow == 4 and feature.orientation[1] and feature.orientation[1].orientationValue then
            featurePortrayal:SetDisplayParameters(25060, 6, nil, nil, 'OverRADAR')
            featurePortrayal:AddPointInstruction(Symbol.CreateSymbol('RDOCAL03', feature.orientation.orientationValue, Graphics.CRSType.Geographic))
            if feature.featureName[1] and feature.featureName[1].name then
                featurePortrayal:AddTextInstruction(Text.CreateTextPoint(Text.CreateTextElement(string.format('Nr %s', feature.featureName[1].name), defaultFontCharacteristics, 10, 'CHBLK'), Graphics.CreateVector(3.51, 3.51)), nil, PortrayalModel.CreateDisplayParameters(21, 8))
            end
            if feature.communicationChannel[1] then
