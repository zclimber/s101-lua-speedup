...
local make_function = {
    real = function(name)
        ...
        if not multObjects then
            fun = function(obj)
                local len = C.LuaHost2_getRealAttributes(obj.attr_node_ptr, name, buf, 100)
                if len == 0 then
                    return nil
                else
                    return buf[1]
    ...
    integer = function(name)
        ...
        if not multObjects then
            fun = function(obj)
                local len = C.LuaHost2_getIntegerAttributes(obj.attr_node_ptr, name, buf, 100)
                if len == 0 then
                    return nil
                else
                    return buf[1]
    ...
    boolean = function(name)
        ...
        if not multObjects then
            fun = function(obj)
                local len = C.LuaHost2_getBoolAttributes(obj.attr_node_ptr, name, buf, 100)
                if len == 0 then
                    return nil
                else
                    return buf[1]
    ...
    text = function(name)
        ...
        if not multObjects then
            fun = function(obj)
                local len = C.LuaHost2_getTextAttributes(obj.attr_node_ptr, name, buf, 100)
                if len == 0 then
                    return nil
                else
    ...
    complex = function(name)
        ...
        if not multObjects then
            fun = function(obj)
                local len = C.LuaHost2_getComplexAttributes(obj.attr_node_ptr, name, buf, 100)
                if len == 0 then
                    return nil
                else
